...
<meta name=description property="og:description" content="Website + domain name, 2016.">
...
clickingSound = document.getElementById('click');
bg = document.getElementById("top");
